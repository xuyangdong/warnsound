...
class CreateEditPanel extends React.Component {
	...
	handleSubmit = e => {
		...
		return this.uploadIcon().then(iconUrl => {
			const jsonData = {
				title:getFieldValue('title'),
				guide:getFieldValue('guide'),
				coverUrl:iconUrl,
				isSet:0,
				tellCount:0,
				recommend:0,
			...
			<div className={styles.container}>
				...
				<Form onSubmit={this.handleSubmit}>
					...
					{getFieldDecorator('title',{
						initialValue:storySetInfo.get('title')
					})(
					...
					{getFieldDecorator('guide',{
						initialValue:storySetInfo.get('guide')
					})(
						this.props.type=='edit'?<Input/>:<EnhanceInput />
					)}
					</FormItem>
